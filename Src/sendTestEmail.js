...
async function sendTest(to) {
  ...
  // Optional tls.rejectUnauthorized override for debugging (not recommended for production)
  ...
  try {
    ...
    try {
      ...
      console.error('Error printing details:', e);
    }
    // Also print some common fields
